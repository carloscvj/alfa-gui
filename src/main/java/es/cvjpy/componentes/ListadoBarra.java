 ...
 * @author CarlosVJ
 */
public class ListadoBarra extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        fechaEmisionPanel = new javax.swing.JPanel();
        alfaDatePicker1 = new es.cvjpy.componentes.AlfaDatePicker();
        tituloInformePanel = new javax.swing.JPanel();
        tituloInformeCampo = new javax.swing.JTextField();

        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("alfalit"); // NOI18N
        teclasPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("Accion"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 8))); // NOI18N
        ...
        teclasPanel.setLayout(flowLayout1);
        ...
        fechaEmisionPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("Fecha_de_emision"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 8))); // NOI18N
        fechaEmisionPanel.setMinimumSize(new java.awt.Dimension(150, 60));
        fechaEmisionPanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 5, 10));

        alfaDatePicker1.setPreferredSize(new java.awt.Dimension(180, 23));

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${datos.cabeceraListado.fechaEmision}"), alfaDatePicker1, org.jdesktop.beansbinding.BeanProperty.create("date"));
        bindingGroup.addBinding(binding);

        fechaEmisionPanel.add(alfaDatePicker1);

        add(fechaEmisionPanel);

        tituloInformePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("Titulo_del_informe"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 8))); // NOI18N

        tituloInformeCampo.setFont(tituloInformeCampo.getFont().deriveFont((tituloInformeCampo.getFont().getStyle() | java.awt.Font.ITALIC) | java.awt.Font.BOLD, tituloInformeCampo.getFont().getSize()+6));
        tituloInformeCampo.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        tituloInformeCampo.setPreferredSize(new java.awt.Dimension(327, 30));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${datos.cabeceraListado.titulo}"), tituloInformeCampo, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        tituloInformePanel.add(tituloInformeCampo);

        add(tituloInformePanel);
    ...
    private es.cvjpy.componentes.AlfaDatePicker alfaDatePicker1;
    ...
    private javax.swing.JPanel fechaEmisionPanel;
    private javax.swing.JPanel teclasPanel;
    private javax.swing.JTextField tituloInformeCampo;
    private javax.swing.JPanel tituloInformePanel;
    ...
    public Boolean getFechaEmisionVisible() {
        return fechaEmisionPanel.isVisible();
    }

    public void setFechaEmisionVisible(Boolean fechaEmisionVisible) {
        this.fechaEmisionPanel.setVisible(fechaEmisionVisible);
    }

    public Boolean getTituloInformeVisible() {
        return tituloInformePanel.isVisible();
    }

    public void setTituloInformeVisible(Boolean tituloInformeVisible) {
        this.tituloInformePanel.setVisible(tituloInformeVisible);
    }

    public double getTituloInformeAncho() {
        return tituloInformeCampo.getPreferredSize().getWidth();
    }

    public void setTituloInformeAncho(double ancho) {
        tituloInformeCampo.setPreferredSize(new Dimension((int) ancho, tituloInformeCampo.getPreferredSize().height));
    }
    private ActInfCliPro datos;

    public static final String PROP_DATOS = "datos";

    public ActInfCliPro getDatos() {
        return datos;
    }

    public void setDatos(ActInfCliPro datos) {
        ActInfCliPro oldDatos = this.datos;
        this.datos = datos;
